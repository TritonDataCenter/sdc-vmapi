...
| zfs_snapshot_limit       | Number                        | Sets the number of ZFS snapshots a VM can take. Undefined or null indicates no limits, and setting null disables previously-set limits.    | Yes                 | Yes    | Yes    |
