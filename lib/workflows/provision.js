...
function provision(job, cb) {
    ...
    function preparePayload(params) {
        ...
        var keys = [ 'alias', 'autoboot', 'billing_id', 'brand', 'cpu_cap',
            ...
            'fs_allowed', 'hostname', 'internal_metadata', 'max_locked_memory',
            'max_lwps', 'max_physical_memory', 'max_swap', 'nics', 'owner_uuid',
            'package_name', 'package_version', 'quota', 'ram', 'resolvers',
            'vcpus', 'zfs_data_compression', 'zfs_io_priority', 'tags'
        ];
