...
function getServers(job, cb) {
    ...
    var cnapi = restify.createJsonClient({ url: cnapiUrl, connectTimeout: 10000, log: job.log });
...
function getAllocation(job, cb) {
    ...
    var dapi = restify.createJsonClient({ url: dapiUrl, connectTimeout: 10000, log: job.log });
...
function getNICs(job, cb) {
    ...
    var napi = restify.createJsonClient({ url: napiUrl, connectTimeout: 10000, log: job.log });
