...
/*
 * Loads a machine from UFDS. Available in the callback(err, machine)
 */
function loadMachine(req, res, next) {
  req.log.trace('loadMachine start');
  var baseDn;
...
function mount(server, before) {
  ...
  server.get({ path: '/machines/:uuid', name: 'GetMachine' },
               before, loadMachine, getMachine);

  server.post({ path: '/machines/:uuid', name: 'UpdateMachine' },
                before, loadMachine, updateMachine);
}
