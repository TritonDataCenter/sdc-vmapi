...
Heartbeater.prototype.onReady = function () {
    ...
    // Temporal fix for not consuming heartbeats and calling machine_load every
    // time. AGENT-469 will give us a timestamp so we can check when the zone
    // properties have changed.
    // Every 60 hearbeats and there is one heartbeat every 5 seconds, i.e.
    // every 5 minutes.
    var hbCount = 0;
