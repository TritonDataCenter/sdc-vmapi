...
function updateVmOnMoray(vmapi, uuid, hb, vm, cb) {
    ...
    // CNAPI reports, we need to make sure to use the heartbeat as a rerference.
    // After all, the next heartbeat will have an updated state (if there is)
    m.state = hb.state;
    m['zone_state'] = hb['zone_state'];
