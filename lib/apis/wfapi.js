...
/*
 * Pings WFAPI by getting the provision workflow (until /ping is in WFAPI)
 */
Wfapi.prototype.ping = function (callback) {
    this.client.findWorkflow('provision', function (err, req, res) {
        return callback(err);
    });
};
...
Wfapi.prototype.createAddNicsJob = function (req, networks, cb) {
    ...
    self.client.createJob('add-nics', params, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createRemoveNicsJob = function (req, macs, cb) {
    ...
    self.client.createJob('remove-nics', params, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createSnapshotJob = function (req, cb) {
    ...
    self.client.createJob('snapshot', params, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createRollbackJob = function (req, cb) {
    ...
    self.client.createJob('rollback', params, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createDeleteSnapshotJob = function (req, cb) {
    ...
    self.client.createJob('delete-snapshot', params, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
