...
function getRequestHeaders(req) {
    ...
    } else if (req.headers['request-id']) {
        return { 'request-id': req.headers['request-id'] };
    } else {
        return {};
    }
}
...
Wfapi.prototype.createProvisionJob = function (req, cb) {
    ...
    var headers = getRequestHeaders(req);
    ...
    self.client.createJob('provision', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createStartJob = function (req, cb) {
    ...
    self.client.createJob('start', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createStopJob = function (req, cb) {
    ...
    self.client.createJob('stop', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createRebootJob = function (req, cb) {
    ...
    self.client.createJob('reboot', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createReprovisionJob = function (req, cb) {
    ...
    self.client.createJob('reprovision', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createDestroyJob = function (req, cb) {
    ...
    if (req.headers['x-joyent-context']) {
        try {
            params.context = JSON.parse(req.headers['x-joyent-context']);
        } catch (e) {
            // Moooving forward, no big deal
        }
    }

    self.client.createJob('destroy', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createUpdateJob = function (req, params, cb) {
    ...
    if (req.params.context !== undefined) {
        params.context = req.params.context;
    }

    self.client.createJob('update', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
 ...
 */
Wfapi.prototype.createAddNicsJob = function (req, networks, cb) {
    var self = this;
    var params = { networks: networks };
    var vm_uuid = req.vm.uuid;
    var headers = getRequestHeaders(req);
    ...
    self.client.createJob('add-nics', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createRemoveNicsJob = function (req, macs, cb) {
    ...
    self.client.createJob('remove-nics', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createSnapshotJob = function (req, cb) {
    ...
    if (!params['snapshot_name']) {
        params['snapshot_name'] = formatTimestamp();
    }

    self.client.createJob('snapshot', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createRollbackJob = function (req, cb) {
    ...
    self.client.createJob('rollback', params, headers, function (err, job) {
        if (err) {
            cb(err);
            return;
        }
...
Wfapi.prototype.createDeleteSnapshotJob = function (req, cb) {
    ...
    self.client.createJob('delete-snapshot', params, headers,
      function (err, job) {
        if (err) {
            cb(err);
            return;
