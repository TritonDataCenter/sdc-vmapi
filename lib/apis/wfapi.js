...
/*
 * Finds or Creates a workflow. A new workflow is created when there is none
 * yet or when we want to replace an existing one
 */
Wfapi.prototype.findOrCreateWorkflow = function (wf) {
    var self = this;
 ...
 */
Wfapi.prototype.findWorkflow = function (name, cb) {
 ...
 */
Wfapi.prototype.getWorkflow = function (uuid, cb) {
