...
Moray.prototype.listVms = function countVms(params, cb) {
    ...
    return self._vmsListParams(params, function (err, filter, sortOptions) {
        ...
        sql += self._addStateFilter(params, filter.length);
        sql += sortOptions;
...
/*
 * Adds a state condition that takes care of state=active too
 */
Moray.prototype._addStateFilter = function(params, conditions) {
    var filter = '';
