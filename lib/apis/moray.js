            ...
            if (!putObjErr) {
                ...
                if (oldVm && self._changefeedPublisher) {
                    ...
                    common.publishChange(self._changefeedPublisher,
                        VM_CHANGEFEED_RESOURCE_NAME, diffs, vm.uuid, vm,
...
Moray.prototype.getVmMigrations = function (params, cb) {
    ...
    Object.keys(params).forEach(function (param) {
        ...
        // Active is deprecated - ignore this param and return all states.
        } else if (param !== 'state' || params.state !== 'active') {
