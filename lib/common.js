...
function machineToUfds(machine) {
    machine.nics = JSON.stringify(machine.nics);
    machine.tags = JSON.stringify(machine.tags);
    machine.internal_metadata = JSON.stringify(machine.internal_metadata);
    machine.customer_metadata = JSON.stringify(machine.customer_metadata);
    return machine;
}
