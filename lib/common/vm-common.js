...
function translateVm(obj, fullObject) {
    ...
    if (obj['package_name']) {
        vm['package_name'] = obj['package_name'];
    }

    if (obj['package_version']) {
        vm['package_version'] = obj['package_version'];
    }

    if (obj['fs_allowed']) {
        vm['fs_allowed'] = obj['fs_allowed'];
    }

    if (obj['maintain_resolvers']) {
        vm['maintain_resolvers'] = obj['maintain_resolvers'];
    }

    if (obj['indestructible_zoneroot']) {
        vm['indestructible_zoneroot'] = obj['indestructible_zoneroot'];
    }

    if (obj['indestructible_delegated']) {
        vm['indestructible_delegated'] = obj['indestructible_delegated'];
    }
