...
function translateVm(obj, fullObject) {
    ...
    var optionalFields = ['dns_domain', 'delegate_dataset', 'fs_allowed',
        'indestructible_zoneroot', 'indestructible_delegated',
        'limit_priv', 'maintain_resolvers', 'mdata_exec_timeout',
        'package_name', 'package_version', 'zfs_data_compression', 'tmpfs'];
