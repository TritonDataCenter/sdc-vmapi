...
function validOwner(vm, params) {
    ...
    if (owner_uuid) {
        if (!validUUID(owner_uuid)) {
            throw new restify.InvalidArgumentError('Owner UUID is not a valid UUID');
        }
...
function validateParams(ufds, params, callback) {
    ...
    if (params.server_uuid && !validUUID(params.server_uuid)) {
        return callback(
                new restify.InvalidArgumentError('Server UUID is not a valid UUID'));
    }
    ...
    if (!validUUID(params.dataset_uuid)) {
        return callback(
                new restify.InvalidArgumentError('Dataset UUID is not a valid UUID'));
    }
    ...
    if (params.alias && !validAlias(params.alias)) {
        return callback(new restify.InvalidArgumentError('Alias ' + params.alias +
                                           ' is invalid'));
    }
...
exports.validateUpdate = function(obj) {
    ...
    if (obj.owner_uuid) {
        if (typeof(obj.owner_uuid) === 'string' && validUUID(obj.owner_uuid)) {
            ...
            throw new restify.InvalidArgumentError('Owner UUID ' + obj.owner_uuid +
                                            ' is invalid');
        }
    }
    ...
    if (obj.customer_metadata) {
        if (typeof(obj.customer_metadata) === 'object') {
            ...
            throw new restify.InvalidArgumentError('Customer metadata ' +
    ...
    if (obj.internal_metadata) {
        if (typeof(obj.internal_metadata) === 'object') {
            ...
            throw new restify.InvalidArgumentError('Internal metadata ' +
    ...
    if (obj.tags) {
        if (typeof(obj.tags) === 'object') {
            ...
            throw new restify.InvalidArgumentError('Tags ' + obj.tags + ' is invalid');
        }
    }
