...
var validators = {
    ...
    zfs_snapshot_limit: function (params) {
         ...
         *
         * Worse, is that vmadm(1M) uses the empty string ('') for
         * disabling limits, so vmadm(1M)/the-PI must be updated to
         * deal with translating VMAPI's null.
         *
         * NOTE that VMAPI doesn't accept empty strings.
         *
         * This constitutes a Flag Day for PIs that wish to use this VMAPI
         * function.  Any pre-flag-day PI can use this feature, but a null
         * will not cancel snapshot limit enforcement, but will lower it to
         * 0 (i.e. NO SNAPSHOTS ALLOWED).
         */
