...
var validators = {
    ...
    zfs_snapshot_limit: function (params) {
         ...
         * disabling limits, so either vmadm(1M)/the-PI must deal with
         * translating VMAPI's null, or we must translate here.  NOTE
         * that VMAPI doesn't accept empty strings.
         *
         * To avoid requiring a PI update for this VMAPI feature, we
         * opt to translate the VMAPI value to the vmadm(1M) value
         * here.
         */
        if (params.zfs_snapshot_limit === undefined) {
            ...
            // We wish to make sure vmadm(1M) gets it set to '' in this case.
