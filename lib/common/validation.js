...
function validateParams(ufds, params, callback) {
    ...
    if (!params.dataset_uuid) {
         return callback(
            new restify.MissingParameterError('\'dataset_uuid\' is required'));
    }
    ...
    // nics and networks
    if (params.nics) {
        if (typeof(params.nics) === 'string') {
            try {
                params.nics = JSON.parse(params.nics);
            } catch (e) {
                return callback(
    ...
    if (obj.customer_metadata) {
        if (typeof(obj.customer_metadata) === 'object') {
            ...
            try {
                ...
                validMetadata('customer_metadata',
                              params['set_customer_metadata']);
            } catch (e) {
                return callback(
                    new restify.InvalidArgumentError('\'%s\' is not valid ' +
            ...
            throw new restify.InvalidArgumentError('\'customer_metadata\' ' +
    ...
    if (obj.internal_metadata) {
        if (typeof(obj.internal_metadata) === 'object') {
            ...
            try {
                ...
                validMetadata('internal_metadata',
                              params['set_internal_metadata']);
            } catch (e) {
                return callback(
                    new restify.InvalidArgumentError('\'%s\' is not valid ' +
            ...
            throw new restify.InvalidArgumentError('\'internal_metadata\' ' +
    ...
    if (obj.tags) {
        if (typeof(obj.tags) === 'object') {
            ...
            try {
                ...
                validMetadata('tags', params['set_tags']);
            } catch (e) {
                return callback(
                    new restify.InvalidArgumentError('\'%s\' are not valid ' +
                            '\'tags\'', obj.tags));
            ...
            throw new restify.InvalidArgumentError('\'tags\' ' + obj.tags
                                                    + ' are invalid');
        }
    }
...
exports.setDefaultValues = function(params) {
    ...
    if (params.ips && typeof (params.ips) === 'string')
