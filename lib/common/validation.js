...
var validators = {
    ...
    zfs_snapshot_limit: function (params) {
        ...
        if (params.zfs_snapshot_limit === undefined) {
            // This should make vmadm(1M) not do anything.
            delete params.zfs_snapshot_limit;
        } else if (params.zfs_snapshot_limit === null) {
            // We wanna make sure vmadm(1M) gets it set to '' in this case.
            params.zfs_snapshot_limit = '';
        } else {
            // Unless there's a better way using createValidateNumberFn...
            var error;
